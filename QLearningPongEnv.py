...
FIELD_WIDTH = 210 # The total width of the playing field / game window
...
BALL_SPEED_X = 1.35 # the speed of the ball in the x direction
BALL_SPEED_Y = 1.35 # the speed of the ball in the y direction 
